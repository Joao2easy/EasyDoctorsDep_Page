...
export default function WhatsAppFloat() {
  const handleWhatsAppClick = () => {
    ...
    const message = "Olá! Preciso de ajuda com o EasyDoctors.";
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <div className="absolute right-full top-1/2 transform -translate-y-1/2 mr-3 bg-gray-900 text-white text-sm px-3 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none">
        Precisa de Ajuda?
