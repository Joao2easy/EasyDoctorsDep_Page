...
import { Clock, Mail, Smartphone, Globe } from "lucide-react";
import { track } from "@/lib/fbq";

export default function EstamosQuaseLaPage() {
  useEffect(() => {
    // Disparar evento de página vista
    if (typeof window !== "undefined") {
      track("PageView", {
        page_name: "estamos-quase-la"
      });
    }
  }, []);
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <Card className="shadow-xl border-0 bg-white mb-8">
            <CardHeader className="text-center pb-8 pt-12">
              <div className="w-20 h-20 bg-[#74237F] rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <CardDescription className="text-lg text-gray-600 leading-relaxed">
                Recebemos o cadastro dos dependentes. Em instantes, você receberá um e-mail com seu acesso (login e senha).
              </CardDescription>
            </CardHeader>
          </Card>
